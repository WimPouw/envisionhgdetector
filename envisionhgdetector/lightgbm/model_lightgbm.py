...
class LightGBMGestureModel:
    ...
    def predict_frame(self, frame: np.ndarray) -> Tuple[Optional[str], Optional[float]]:
        ...
        if confidence < self.confidence_threshold:
            return Labels.NOGESTURE, 1.0 - probs[1]  # Return NoGesture confidence
        ...
        for landmarks in landmarks_per_frame:
            ...
            if features is not None:
                ...
                if gesture_name == Labels.NOGESTURE:
                    ...
                    move_conf = 0.0
                elif gesture_name == Labels.GESTURE:
                    gesture_conf = confidence
                    move_conf = 0.0
                    nogesture_conf = 1-confidence
                elif gesture_name == Labels.MOVE: # TODO - do we need this?
                    gesture_conf = 0.0
    ...
    def _predict_video(
        ...
        results_df = expand_predictions_to_frames(
            sparse_results_df,
            total_frames,
            fps
        )
